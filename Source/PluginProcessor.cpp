...
void CLA2AStyleAudioProcessor::updateCompressorSettings()
{
    ...
    inputGainLinear = juce::Decibels::decibelsToGain(gainDb != nullptr ? *gainDb : kDefaultGainDb);
    compressionControl = comp != nullptr ? *comp : kDefaultCompression;
    deEsserEnabled = deEsser != nullptr && (*deEsser >= 0.5f);
